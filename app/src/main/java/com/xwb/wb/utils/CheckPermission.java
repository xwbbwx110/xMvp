...
import com.xwb.wb.ui.dialog.PermissionInfoDialog;
...
public class CheckPermission {
     ...
     * 直接申请，包括判断和弹对话框
     */
    public static void DirectApplyPermission(BaseWBActivity ac, String permission, String perDeatil){
     ...
     * @return
     */
    public static   void ApplyPermission(final BaseWBActivity ac, final String permission, final String perDeatil){
     ...
     * @return
     */
    public static boolean isGranted(BaseWBActivity ac, String permission){
