...
import com.xwb.wb.enity.request.ApiService;
        ...
        if (sRetrofit == null) {
            synchronized (mRetrofitLock) {
                if (sRetrofit == null) {
                    ...
                    File cacheFile = new File(MyApplication.getAppLicationContext().getCacheDir(), "cache");
...
//    }
    ...
    private static class HttpHeaderInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            //  将token统一放到请求头
            String token= (String) SharedPreferencesHelper.get(MyApplication.getAppLicationContext(),"token","");
            //  也可以统一配置用户名
