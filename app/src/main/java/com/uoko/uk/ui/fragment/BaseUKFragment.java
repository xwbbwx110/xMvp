package com.uoko.uk.ui.fragment;
...
public abstract class BaseUKFragment<P extends BaseLifecyclePresenter> extends RxFragment implements BaseMVPView{

    private P mPresenter;

    BaseUKActivity mActivity;

    public BaseUKActivity getmActivity() {
        return mActivity;
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                RxBus.get().register(BaseUKFragment.this);
            }
        }).start();
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        RxBus.get().unRegister(BaseUKFragment.this);
        if(mPresenter!=null){
